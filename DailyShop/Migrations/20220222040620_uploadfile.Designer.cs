...
namespace DailyShop.Migrations
{
    ...
    [Migration("20220222040620_uploadfile")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DailyShop.Areas.Admin.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DailyShop.Areas.Admin.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DailyShop.Areas.Admin.Models.Invoices", b =>
                {
                    ...
                    b.HasOne("DailyShop.Areas.Admin.Models.User", "Users")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("DailyShop.Areas.Admin.Models.InvoicesDetail", b =>
                {
                    ...
                    b.HasOne("DailyShop.Areas.Admin.Models.Product", "Products")
                        .WithMany("InvoicesDetail")
            ...
            modelBuilder.Entity("DailyShop.Models.Cart", b =>
                {
                    b.HasOne("DailyShop.Areas.Admin.Models.Product", "Product")
                        .WithMany("Carts")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DailyShop.Areas.Admin.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
